...
@section('page_title', 'Create Portal User')
@section('page_subtitle', 'Add a Zendy sign-in account')
...
<div class="card-surface form-card" style="max-width: 720px;">
    ...
    <form action="{{ route('zendy.users.store') }}" method="POST">
        @csrf
        ...
        <div class="form-section">
            ...
            <div class="form-row-2">
                <div class="form-group-app">
                    ...
                    <input type="text" id="campus" name="campus" value="{{ old('campus') }}" class="form-control-app">
                </div>
                <div class="form-group-app">
                    <label for="department">Department</label>
                    <input type="text" id="department" name="department" value="{{ old('department') }}" class="form-control-app">
                </div>
            </div>
            <div class="form-group-app" id="courseField">
                <label for="course">Course</label>
                <input type="text" id="course" name="course" value="{{ old('course') }}" class="form-control-app">
