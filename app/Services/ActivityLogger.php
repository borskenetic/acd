...
class ActivityLogger
{
    ...
    public function actionLabels(): array
    {
        return [
            ...
            'logout' => 'Logged out',
            'school_calendar.store' => 'Set school calendar day',
            'school_calendar.destroy' => 'Cleared school calendar override #:schoolCalendar',
            'students.store' => 'Registered student',
            'students.update' => 'Updated student #:id',
            'students.destroy' => 'Deleted student #:id',
            'students.faculty.update' => 'Faculty updated student record',
            'students.faculty.destroy' => 'Faculty deleted student record',
