    ...
    <div id="routeWrapper" class="ms-auto responsive-nav">
        ...
        @auth('web')
            @can('isAdminOrStaff')
                ...
                <div class="nav-dropdown">
                    <button type="button" class="nav-dropdown-button {{ $dropActive(['sf2.*', 'attendance_logs.*', 'missed_outs.*', 'visitor_logs.*']) }}">
                        Reports
                    </button>
                    <div class="nav-dropdown-content">
                        ...
                        <a href="{{ route('missed_outs.index') }}" class="{{ $linkActive(['missed_outs.*']) }}">Missed Outs</a>
                ...
                @can('isAdmin')
                    <div class="nav-dropdown">
                        <button type="button" class="nav-dropdown-button {{ $dropActive(['users.*', 'school-setup.*', 'prospectus.*', 'school_calendar.*', 'attendance.policy.*', 'gate_devices.*', 'activity_logs.*']) }}">
                            Admin
                        </button>
                        <div class="nav-dropdown-content">
